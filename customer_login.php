<?php
  ...
  if(isset($_POST['btnRegister'])){
    ...
    $sql = "SELECT * FROM customer WHERE Email='$username' and passwd='$password'";
...
<body>
  <header>
    ...
    <ul>
      <li class="dropdown">
        <a href="customer_login.php" class="dropbtn">Be Our Partner</a>
        <div class="dropdown-content">
          <a href="rider_register.php">Rider</a>
          <a href="restaurant_register.php">Restaurant</a>
        </div>
      </li>
      <li><a href="customer_login.php" class="active">Login</a></li>
